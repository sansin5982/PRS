...
> inherited genetic susceptibility to a trait or disease. It is a
> probability-related predictor, not a diagnosis, destiny or proof of
> causation.
...
For every usable variant, the GWAS may provide an **effect estimate**,
often called a *weight*. The weight describes the estimated direction
and size of the variant’s association with the studied outcome.
...
performance may be exaggerated. We will study this problem in Chapter 7.

# 4. What is being counted?

At one genetic position, a person usually has two allele copies: one
...
0.97 or 1.84. A decimal represents uncertainty about the unobserved
genotype; it does not mean that a person literally possesses a fraction
of an allele.
...
Suppose a published score contains five variants. For one person, the
calculation is:
...
Allele frequencies, linkage disequilibrium patterns, environmental
contexts and GWAS representation differ across populations. A score
developed in one ancestry group may lose accuracy or become poorly
calibrated in another.

This is not a minor technical issue. It is central to valid and
equitable PRS analysis.
...
Coronary artery disease is influenced by many genetic and non-genetic
factors. A coronary artery disease PRS may combine the effects of
numerous variants to identify people with relatively higher inherited
susceptibility.
...
Consider two hypothetical people with equally high coronary artery
disease PRSs:
...
information about published scores.

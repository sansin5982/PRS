...
<img src="figures/chapter-03-ch03-gwas-prs-workflow-1.png" alt="Figure 3.1: The complete conceptual path from a discovery GWAS to independent PRS evaluation." width="90%" />
<p class="caption">
...
<img src="figures/chapter-03-ch03-quantitative-effect-1.png" alt="Figure 3.2: A simplified additive variant effect for a quantitative trait. The points show expected means, not every person's observed measurement." width="90%" />
<p class="caption">
...
<img src="figures/chapter-03-ch03-confidence-interval-figure-1.png" alt="Figure 3.3: Identical beta estimates can have very different precision. Study B's wider confidence interval reflects greater uncertainty." width="90%" />
<p class="caption">
...
<img src="figures/chapter-03-ch03-simulated-manhattan-1.png" alt="Figure 3.4: A simulated Manhattan-style plot. PRS methods may use information beyond the few variants crossing the genome-wide significance line." width="90%" />
<p class="caption">

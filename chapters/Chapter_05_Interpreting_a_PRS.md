...
1.  distinguish raw scores, Z-scores, percentiles and disease
    probabilities;
2.  interpret an odds ratio per standard deviation with a defined
    comparison;
3.  explain why high and low scores do not determine individual
    outcomes;
4.  distinguish association, discrimination, calibration and clinical
    utility;
5.  interpret sensitivity, specificity and positive predictive value;
6.  explain why population context and uncertainty matter; and
7.  write a short, scientifically defensible PRS interpretation.
...
<img src="figures/chapter-05-ch05-overlapping-distributions-1.png" alt="Figure 5.1: Schematic overlapping score distributions. These curves are invented, not an estimate of any particular disease's PRS performance." width="90%" />
<p class="caption">
...
<img src="figures/chapter-05-ch05-absolute-probabilities-1.png" alt="Figure 5.2: Fictional probability comparisons under OR = 2. The same odds ratio produces different absolute changes." width="90%" />
<p class="caption">
...
<img src="figures/chapter-05-ch05-calibration-figure-1.png" alt="Figure 5.3: Calibration in simulated evaluation data. The second model keeps the same ranking but overestimates probabilities. Vertical bars show pointwise 95% binomial intervals; each group contains 500 people." width="90%" />
<p class="caption">
...
<img src="figures/chapter-05-ch05-improvement-figure-1.png" alt="Figure 5.4: Simulated improvement in test AUC after adding PRS, with a paired bootstrap percentile interval conditional on the fitted models." width="90%" />
<p class="caption">

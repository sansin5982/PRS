...
1.  explain the meaning of *polygenic risk score* in everyday language;
2.  describe why many genetic variants are combined;
3.  explain the basic weighted-sum calculation;
4.  distinguish a PRS from a single-gene mutation and family history;
5.  state what a high or low PRS does and does not mean; and
6.  identify the information needed before interpreting a PRS.
...
<img src="figures/chapter-01-ch01-prs-concept-diagram-1.png" alt="Figure 1.1: A simplified path from a discovery GWAS to an individual's polygenic risk score." width="90%" />
<p class="caption">
...
<img src="figures/chapter-01-ch01-variant-contributions-1.png" alt="Figure 1.2: Contribution of each variant to the example person's raw PRS. A negative weight lowers the score." width="90%" />
<p class="caption">
...
<img src="figures/chapter-01-ch01-reference-distribution-1.png" alt="Figure 1.3: A hypothetical PRS distribution. The highlighted person has a relatively high score, but the figure does not provide an absolute disease probability." width="90%" />
<p class="caption">

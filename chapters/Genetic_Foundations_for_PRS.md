...
<img src="figures/chapter-02-genetic-hierarchy-1.png" alt="Figure 2.1: A simplified hierarchy from a person to a DNA base. A PRS uses variation observed at many genomic positions." width="90%" />
<p class="caption">
...
<img src="figures/chapter-02-genotype-dosage-diagram-1.png" alt="Figure 2.2: Effect-allele dosage depends on which allele is counted. Here, G is the effect allele." width="90%" />
<p class="caption">
...
<img src="figures/chapter-02-imputed-dosage-1.png" alt="Figure 2.3: Example genotype probabilities for an imputed variant. Their probability-weighted average produces an effect-allele dosage of 1.65." width="90%" />
<p class="caption">

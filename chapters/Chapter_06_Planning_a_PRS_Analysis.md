...
1.  write a specific PRS research question;
2.  distinguish score calculation, association testing, model
    development and validation;
3.  identify the data required for each task;
4.  distinguish discovery, LD, tuning, testing and percentile-reference
    data;
5.  recognize sample overlap and data leakage;
6.  explain why event counts matter more than a sample-size headline
    alone;
7.  choose evaluation measures that match the question; and
8.  produce an analysis plan and dataset manifest.
...
<img src="figures/chapter-06-ch06-data-roles-1.png" alt="Figure 6.1: A simplified design using external GWAS and target development/test data. The final test evaluates a fixed model; its outcomes do not feed model selection." width="90%" />
<p class="caption">
...
<img src="figures/chapter-06-ch06-precision-figure-1.png" alt="Figure 6.2: Approximate uncertainty decreases as case counts increase. This illustrates sensitivity precision only; it is not a PRS study sample-size calculator." width="90%" />
<p class="caption">
...
<img src="figures/chapter-06-ch06-selection-figure-1.png" alt="Figure 6.3: Selecting among random candidates raises apparent development performance. Independent evaluation exposes the lack of signal across repetitions." width="90%" />
<p class="caption">
